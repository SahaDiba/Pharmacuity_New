...
describe('Trial Forecasting Page', function () {
  ...
  it('Functional View FPI-LPI Graph: Actuals Vs Q1,Q3', function () {

    var workbook = new Excel.Workbook();
    var worksheet = workbook.addWorksheet('Trial Forecasting_Functional View_FPI to LPI Validation');
    ...
    worksheet.getRow(2).values = ['TherapeuticArea', 'ClinicalIndication', 'Protocol', 'Predicted Q1', 'Predicted Q2', 'Predicted Q3', 'Actual Value',
      'Deviation', 'Percent deviation', 'Predicted Q1', 'Predicted Q2', 'Predicted Q3', 'Actual Value at 100% Patient Enrolled', 'Actual Value at  50% Patient Enrolled',
      'Deviation of Actuals at 100% Patient Enrolled', 'Percent deviation'];
    worksheet.columns = [
      { key: 'TA' },
      { key: 'CI' },
      { key: 'Pr' },
    ...
    var ProcessMenu = (totalSubMenuCount, currentSubMenuCount, menuIndex) => {
      ...
      element(by.xpath('//*[@id="tf-fpi-lpi"]/div/multi-line-chart/svg:svg')).isPresent().then(function (isVisible) {
        if (isVisible) {
          if (menuIndex == 2 && currentSubMenuCount == 0) {
            browser.sleep(10000);
            myPO.moveSlider("tf-fpi-lpi");
            browser.sleep(5000);
            myPO.clickOnLegendBox("tf-fpi-lpi");

          }

          if (menuIndex == 2) {
            myPO.setPercentActuals("FPI-LPI-pane", 0);
            var promisearray = [];
            var bool = false;
            var Q1, Q2, Q3, A;
            ...
            element(by.xpath('//*[@id="tf-fpi-lpi"]/div/multi-line-chart/div/div[1]/status-board/div/div[1]/div[4]/span[3]')).isPresent().then(function (isvisible) {
              if (isvisible) {
                var q1 = element(by.xpath('//*[@id="tf-fpi-lpi"]/div/multi-line-chart/div/div[1]/status-board/div/div[1]/div[4]/span[3]'));
            ...
            element(by.xpath('//*[@id="tf-fpi-lpi"]/div/multi-line-chart/div/div[1]/status-board/div/div[1]/div[6]/span[3]')).isPresent().then(function (isvisible) {
              if (isvisible) {
                var q2 = element(by.xpath('//*[@id="tf-fpi-lpi"]/div/multi-line-chart/div/div[1]/status-board/div/div[1]/div[6]/span[3]'));
            ...
            element(by.xpath('//*[@id="tf-fpi-lpi"]/div/multi-line-chart/div/div[1]/status-board/div/div[1]/div[8]/span[3]')).isPresent().then(function (isvisible) {
              if (isvisible) {
                var q3 = element(by.xpath('//*[@id="tf-fpi-lpi"]/div/multi-line-chart/div/div[1]/status-board/div/div[1]/div[8]/span[3]'));
            ...
            element(by.xpath('//*[@id="tf-fpi-lpi"]/div/multi-line-chart/div/div[1]/status-board/div/div[1]/div[9]/span[3]')).isPresent().then(function (isvisible) {
              if (isvisible) {
                var actualValue = element(by.xpath('//*[@id="tf-fpi-lpi"]/div/multi-line-chart/div/div[1]/status-board/div/div[1]/div[9]/span[3]'));
                utility.highlightElement(actualValue);
                promisearray.push(actualValue.getText());

              }
              else {
                element(by.xpath('//*[@id="tf-fpi-lpi"]/div/multi-line-chart/div/div[1]/status-board/div/div[1]/div[5]/span[3]')).isPresent().then(function (isdisplayed) {
                  if (isdisplayed) {
                    var actualValue = element(by.xpath('//*[@id="tf-fpi-lpi"]/div/multi-line-chart/div/div[1]/status-board/div/div[1]/div[5]/span[3]'));
                    utility.highlightElement(actualValue);
                    promisearray.push(actualValue.getText());
            ...
            myPO.setPercentActuals("FPI-LPI-pane", 50);
            myPO.moveSlider50("tf-fpi-lpi");
            //Need to change here
            element(by.xpath('//*[@id="tf-fpi-lpi"]/div/multi-line-chart/div/div[1]/status-board/div/div[1]/div[9]/span[3]')).isPresent().then(function (isvisible) {
              if (isvisible) {
                var actualValue = element(by.xpath('//*[@id="tf-fpi-lpi"]/div/multi-line-chart/div/div[1]/status-board/div/div[1]/div[9]/span[3]'));
            ...
            element(by.xpath('//*[@id="tf-fpi-lpi"]/div/multi-line-chart/div/div[1]/status-board/div/div[1]/div[4]/span[3]')).isPresent().then(function (isvisible) {
              if (isvisible) {
                var pq1 = element(by.xpath('//*[@id="tf-fpi-lpi"]/div/multi-line-chart/div/div[1]/status-board/div/div[1]/div[4]/span[3]'));
            ...
            element(by.xpath('//*[@id="tf-fpi-lpi"]/div/multi-line-chart/div/div[1]/status-board/div/div[1]/div[6]/span[3]')).isPresent().then(function (isvisible) {
              if (isvisible) {
                var pq2 = element(by.xpath('//*[@id="tf-fpi-lpi"]/div/multi-line-chart/div/div[1]/status-board/div/div[1]/div[6]/span[3]'));
            ...
            element(by.xpath('//*[@id="tf-fpi-lpi"]/div/multi-line-chart/div/div[1]/status-board/div/div[1]/div[8]/span[3]')).isPresent().then(function (isvisible) {
              if (isvisible) {
                var pq3 = element(by.xpath('//*[@id="tf-fpi-lpi"]/div/multi-line-chart/div/div[1]/status-board/div/div[1]/div[8]/span[3]'));
            ...
            element(by.xpath('//*[@id="tf-fpi-lpi"]/div/multi-line-chart/div/div[1]/status-board/div/div[1]/div[9]/span[3]')).isPresent().then(function (isvisible) {
              if (isvisible) {
                var pactualValue = element(by.xpath('//*[@id="tf-fpi-lpi"]/div/multi-line-chart/div/div[1]/status-board/div/div[1]/div[9]/span[3]'));
                ...
                element(by.xpath('//*[@id="tf-fpi-lpi"]/div/multi-line-chart/div/div[1]/status-board/div/div[1]/div[5]/span[3]')).isPresent().then(function (isdisplayed) {
                  if (isdisplayed) {
                    var pactualValue = element(by.xpath('//*[@id="tf-fpi-lpi"]/div/multi-line-chart/div/div[1]/status-board/div/div[1]/div[5]/span[3]'));
                    utility.highlightElement(pactualValue);
                    promisearray2.push(pactualValue.getText());
            ...
            browser.wait(() => {
              ...
              workbook.xlsx.writeFile("./reports/Trial Forecasting_Functional View_FPI to LPI Validation.xlsx");
              return true;
            }, 1);
