...
module.exports = {  
    clickOnSAtoFPI: function()
    {
        var sA_FPI = element(by.xpath('//*[@id="pharmAcquity"]/div[2]/div[1]/div/md-tabs/md-tabs-wrapper/md-tabs-canvas/md-pagination-wrapper/md-tab-item[3]/span'));
        sA_FPI.click();
